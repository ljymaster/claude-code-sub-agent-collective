...
class CollectiveValidator {
  ...
  async validateSettings() {
    ...
    try {
      ...
      // Check required structure (v3.0: removed SubagentStop and PostToolUse)
      ...
      if (!hasHooks || !hasSessionStart || !hasPreToolUse) {
        return {
          name: 'Settings JSON structure',
          passed: false,
          error: 'settings.json missing required hook configuration (SessionStart, PreToolUse)'
        };
      }
