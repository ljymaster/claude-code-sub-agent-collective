...
class CollectiveInstaller {
  ...
  async performStandardInstallation() {
    ...
    // Browser testing notification
    console.log(chalk.cyan('\n🌐 Browser Testing Configuration:'));
    console.log(chalk.green('  ✅ Automated browser testing: ENABLED (default)'));
    console.log('     → Validates CSS loads correctly');
    console.log('     → Tests user interactions (clicks, forms)');
    console.log('     → Verifies DOM state changes');
    console.log('     → Performance impact: ~30-60s per UI task');
    console.log('');
    console.log(chalk.gray('  To disable browser testing:'));
    console.log(chalk.gray('    echo \'{"browserTesting": false}\' > .claude/memory/config.json'));
    console.log('');
    console.log(chalk.gray('  See .claude-collective/task-system.md for full configuration options'));
