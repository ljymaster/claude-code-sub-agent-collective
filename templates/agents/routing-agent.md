...
This agent is platform-agnostic and works identically on both Claude Code and Qoder CLI.
...
The routing-agent behavior can be configured through your platform's settings file:
