...
# Platform-agnostic metrics collection for Claude Code and Qoder CLI
...
LOG_FILE="$METRICS_DIR/collective-metrics-${PLATFORM}.log"
...
log() {
    echo "[$(timestamp)] [$PLATFORM] $1" >> "$LOG_FILE"
}
...
log "METRICS COLLECTION TRIGGERED - Platform: $PLATFORM, Event: $EVENT, Tool: $TOOL_NAME, Agent: $SUBAGENT_NAME"
