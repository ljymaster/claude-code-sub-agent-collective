...
# AI Code Collective - Directive Enforcement Hook
# Platform-agnostic: Claude Code and Qoder CLI
...
# Set up logging
LOG_FILE="/tmp/directive-enforcer-${PLATFORM}.log"
...
log "DIRECTIVE ENFORCEMENT TRIGGERED - Platform: $PLATFORM, Tool: $TOOL_NAME"
